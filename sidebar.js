...
(function() {
  ...
  var ic = {
    dash: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#0077C8"/><rect x="2" y="8" width="3" height="6" rx="1" fill="#fff"/><rect x="6.5" y="4" width="3" height="10" rx="1" fill="#fff"/><rect x="11" y="6" width="3" height="8" rx="1" fill="#fff"/></svg>',
    ...
    crm: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#F59E0B"/><circle cx="5.5" cy="6" r="2.5" fill="#fff"/><circle cx="10.5" cy="6" r="2.5" fill="#fff"/><path d="M1 14c0-3 2-4.5 4.5-4.5s4.5 1.5 4.5 4.5" fill="#fff" opacity=".7"/><path d="M6 14c0-3 2-4.5 4.5-4.5s4.5 1.5 4.5 4.5" fill="#fff" opacity=".7"/></svg>',
    ...
    money: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#16A34A"/><text x="8" y="12" text-anchor="middle" fill="#fff" font-size="11" font-weight="700" font-family="sans-serif">₩</text></svg>',
    web: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#6366F1"/><circle cx="8" cy="8" r="5" fill="none" stroke="#fff" stroke-width="1.5"/><ellipse cx="8" cy="8" rx="2.5" ry="5" fill="none" stroke="#fff" stroke-width="1.2"/><line x1="3" y1="8" x2="13" y2="8" stroke="#fff" stroke-width="1.2"/></svg>',
    content: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#8B5CF6"/><path d="M4 10L8 4L9 7L12 6L8 12L7 9Z" fill="#fff"/></svg>',
    doc: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#0EA5E9"/><rect x="4" y="3" width="8" height="10" rx="1" fill="#fff"/><rect x="5.5" y="5" width="5" height="1" rx=".5" fill="#0EA5E9"/><rect x="5.5" y="7.5" width="5" height="1" rx=".5" fill="#0EA5E9"/><rect x="5.5" y="10" width="3" height="1" rx=".5" fill="#0EA5E9"/></svg>'
  };
