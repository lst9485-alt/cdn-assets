...
(function() {
  ...
  var ic = {
    ...
    yt: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="3" width="16" height="16" fill="#1F2937"/><path d="M6.5 4.5L11.5 8L6.5 11.5Z" fill="#fff"/></svg>',
    crm: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#1F2937"/><circle cx="5.5" cy="6" r="2.5" fill="#fff"/><circle cx="10.5" cy="6" r="2.5" fill="#fff"/><path d="M1 14c0-3 2-4.5 4.5-4.5s4.5 1.5 4.5 4.5" fill="#fff" opacity=".7"/><path d="M6 14c0-3 2-4.5 4.5-4.5s4.5 1.5 4.5 4.5" fill="#fff" opacity=".7"/></svg>',
    n8n: '<svg width="14" height="14" viewBox="0 0 16 16" style="vertical-align:-2px"><rect rx="2" width="16" height="16" fill="#1F2937"/><text x="8" y="11.5" text-anchor="middle" fill="#fff" font-size="8" font-weight="800" font-family="sans-serif">n8n</text></svg>',
