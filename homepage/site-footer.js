(function () {
  ...
  ready(function () {
    ...
    footer.innerHTML = [
      ...
      '    <div>',
      '      <strong style="display:block;font-size:21px;font-weight:800;color:#f3f4f6;letter-spacing:-0.02em">우리동네 재테크</strong>',
      ...
      '    </div>',
      '    <div>',
      '      <strong style="display:block;font-size:21px;font-weight:800;color:#f3f4f6;letter-spacing:-0.02em">우리동네 클래스</strong>',
