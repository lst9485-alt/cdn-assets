...
window.CONTENT = {
  ...
  pricing: {
    a: { name: "코칭 A", price: 500000, original: 1000000, items: ["온라인 화상회의 약 50분", "코칭 후 최대 90일간 질의응답", "부부동반 가능", "매주 최대 2명만 진행", "상담 리포트 + 자산관리시트 + 체크리스트 PDF"] },
    b: { name: "코칭 B", price: 1200000, original: 2000000, items: ["코칭 A 전체 포함", "+ 동행임장 1회", "매월 선착순 1명만 진행"] }
  },
  reviews: [
  ...
  faqs: [
    ...
    { q: "코칭 A와 B의 차이는 무엇인가요?", a: "동행임장 1회 제외, 모두 동일합니다.\n• 코칭 A (500,000원): 온라인 화상 코칭 약 50분 + 최대 90일 질의응답 + 상담 리포트 + 자산관리시트 + 체크리스트 PDF\n• 코칭 B (1,200,000원): 코칭 A 전체 + 동행임장 1회\n코칭 B는 매월 선착순 1명만 진행합니다." },
